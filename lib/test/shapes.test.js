...
// Test for generateSVG Circle
describe('generateSVG Circle', () => {
  it('Should generate a circle SVG with input from the user', () => {
    ...
    // Test to be run
    const cirSVG = generateSVG(data)
    const test = `<svg width="300" height="200" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <circle cx="60" cy="55" r="40" fill="black"/>
        <text x="60" y="60" text-anchor="middle" fill="purple">wwe</text>
        </svg>`

        expect(cirSVG).toBe(test)
  });
});

// Test for generateSVG Square
describe('generateSVG Square', () => {
  it('Should generate a square SVG with input from the user', () => {
    ...
    // Test to be run
    const squSVG = generateSVG(data)
    const test = `<svg width="300" height="200"  version="1.1" xmlns="http://www.w3.org/2000/svg">
         <rect x="10" y="10" width="100" height="100" fill="white"/>
         <text x="60" y="60" text-anchor="middle" fill="green">ddd</text>
         </svg>`

        expect(squSVG).toBe(test)
  });
});

// Test for generateSVG Triangle
describe('generateSVG Triangle', () => {
  it('Should generate a triangle SVG with input from the user', () => {
    ...
    // Test to be run
    const triSVG = generateSVG(data)
    const test = `<svg width="300" height="200" version="1.1" xmlns="http://www.w3.org/2000/svg">
         <polygon points="50 10, 90 90, 10 90" fill="lightblue"/>
         <text x="50" y="60" text-anchor="middle" fill="green">cls</text>
       </svg>`

        expect(triSVG).toBe(test)
  });
});